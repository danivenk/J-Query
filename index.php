...
<body>
	<div class="container">
		...
		<p class="exp" id="u2">When you start with the .js file you need a command to indicate that it's jQuery. You do this with the $(document) command, after that you put the command .ready() behind it. .ready() tells the jQuery that something is going to happen. between the bracets of .ready() you need to put the function function(){}. In the function(){} you want to put everything the jQuery needs to do.</p>
